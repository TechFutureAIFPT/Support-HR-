...
const TermsPage: React.FC = () => {
  ...
  const renderSectionContent = () => {
    ...
    switch (activeSection) {
      case 'definitions':
        return (
          <div className="space-y-3">
            <div className={`p-4 rounded-none border ${colors.border} ${colors.bg}`}>
              <div className="flex items-center gap-2 mb-1.5">
                <span className={`w-1.5 h-1.5 rounded-none ${colors.text.replace('text-', 'bg-')}`} />
          ...
          <div className="space-y-3">
            <div className={`p-4 rounded-none border ${colors.border} ${colors.bg}`}>
              <div className="flex items-center gap-2 mb-2">
                <span className="w-7 h-7 rounded-none bg-emerald-500/20 text-emerald-400 flex items-center justify-center text-xs font-bold border border-emerald-500/30">2.1</span>
            ...
            <div className={`p-4 rounded-none border ${colors.border} ${colors.bg}`}>
              <div className="flex items-center gap-2 mb-2">
                <span className="w-7 h-7 rounded-none bg-blue-500/20 text-blue-400 flex items-center justify-center text-xs font-bold border border-blue-500/30">2.2</span>
            ...
            <div className={`p-4 rounded-none border ${colors.border} ${colors.bg}`}>
              <div className="flex items-center gap-2 mb-2">
                <span className="w-7 h-7 rounded-none bg-purple-500/20 text-purple-400 flex items-center justify-center text-xs font-bold border border-purple-500/30">2.3</span>
      ...
      case 'ai-disclaimer':
        return (
          <div className="space-y-3">
            <div className={`p-4 rounded-none border ${colors.border} ${colors.bg} flex items-start gap-3`}>
            ...
            <div className={`p-4 rounded-none border ${colors.border} ${colors.bg}`}>
              <div className="flex items-center gap-2 mb-2">
                <span className="w-7 h-7 rounded-none bg-amber-500/20 text-amber-400 flex items-center justify-center text-xs font-bold border border-amber-500/30">3.1</span>
              ...
              <div className="p-3 rounded-none bg-amber-500/10 border border-amber-500/30">
            ...
            <div className={`p-4 rounded-none border ${colors.border} ${colors.bg}`}>
              <div className="flex items-center gap-2 mb-2">
                <span className="w-7 h-7 rounded-none bg-green-500/20 text-green-400 flex items-center justify-center text-xs font-bold border border-green-500/30">3.2</span>
      ...
      case 'responsibility':
        return (
          <div className="space-y-3">
            <div className={`p-4 rounded-none border ${colors.border} ${colors.bg}`}>
              <div className="flex items-center gap-2 mb-2">
                <span className="w-7 h-7 rounded-none bg-blue-500/20 text-blue-400 flex items-center justify-center text-xs font-bold border border-blue-500/30">4.1</span>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="flex items-center gap-2 p-2 rounded-none bg-blue-500/10 border border-blue-500/30">
            ...
            <div className={`p-4 rounded-none border ${colors.border} ${colors.bg}`}>
              <div className="flex items-center gap-2 mb-2">
                <span className="w-7 h-7 rounded-none bg-red-500/20 text-red-400 flex items-center justify-center text-xs font-bold border border-red-500/30">4.2</span>
              ...
              <div className="space-y-1.5">
                {[
                  ...
                  <div key={item} className="flex items-center gap-2 text-slate-400 text-xs">
                    <span className="w-5 h-5 rounded-none bg-red-500/20 text-red-400 flex items-center justify-center flex-shrink-0 text-[10px]">✗</span>
                    {item}
                  </div>
                ))}
              </div>
      ...
      case 'limitation':
        return (
          <div className="space-y-3">
            <div className={`p-3 rounded-none border ${colors.border} ${colors.bg} text-center`}>
            ...
            <div className={`p-4 rounded-none border ${colors.border} ${colors.bg}`}>
              <div className="flex items-start gap-3">
                <span className="w-8 h-8 rounded-none bg-orange-500/20 text-orange-400 flex items-center justify-center font-bold text-sm shrink-0 border border-orange-500/30">A</span>
                <div>
                  <p className="text-slate-300 text-sm leading-relaxed">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    {['Mất lợi nhuận', 'Mất dữ liệu', 'Gián đoạn kinh doanh'].map(item => (
                      <span key={item} className="text-[11px] px-2 py-0.5 rounded-none bg-slate-700/60 text-slate-400 border border-slate-600/50">{item}</span>
                    ))}
                  </div>
                </div>
              </div>
            ...
            <div className={`p-4 rounded-none border ${colors.border} ${colors.bg}`}>
              <div className="flex items-start gap-3">
                <span className="w-8 h-8 rounded-none bg-amber-500/20 text-amber-400 flex items-center justify-center font-bold text-sm shrink-0 border border-amber-500/30">B</span>
                <div>
                  <p className="text-slate-300 text-sm leading-relaxed">
                  ...
                  <div className="mt-3 text-center p-3 rounded-none bg-amber-500/10 border border-amber-500/30">
      ...
      case 'sla-bcp':
        return (
          <div className="space-y-3">
            <div className={`p-4 rounded-none border ${colors.border} ${colors.bg}`}>
              <div className="flex items-center gap-2 mb-2">
                <span className="w-7 h-7 rounded-none bg-green-500/20 text-green-400 flex items-center justify-center text-xs font-bold border border-green-500/30">6.1</span>
            ...
            <div className={`p-4 rounded-none border ${colors.border} ${colors.bg}`}>
              <div className="flex items-center gap-2 mb-2">
                <span className="w-7 h-7 rounded-none bg-purple-500/20 text-purple-400 flex items-center justify-center text-xs font-bold border border-purple-500/30">6.2</span>
              ...
              <div className="space-y-2">
                <div className="p-2.5 rounded-none bg-purple-500/10 border border-purple-500/30 flex items-start gap-2">
                  <span className={`${colors.text} mt-0.5`}>📢</span>
                  <p className="text-purple-200 text-xs leading-relaxed">
                    Thông báo cho Khách hàng <strong>trước ít nhất 30 ngày</strong> (trừ trường hợp khẩn cấp).
                  </p>
                </div>
                <div className="p-2.5 rounded-none bg-indigo-500/10 border border-indigo-500/30 flex items-start gap-2">
  ...
  return (
    <div className="min-h-screen bg-background text-slate-100 overflow-x-hidden">
      ...
      />
      <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-cyan-600/8 rounded-none blur-3xl" />
      <div className="absolute bottom-1/3 left-1/3 w-80 h-80 bg-violet-600/6 rounded-none blur-3xl" />
      ...
      <div className="relative z-20 flex items-center justify-between px-6 py-4 border-b border-white/5">
        ...
        <div className="flex items-center gap-2">
          <Link to="/privacy-policy" className="text-xs text-slate-400 hover:text-cyan-400 transition-colors px-3 py-1.5 rounded-none hover:bg-white/5">Chính sách bảo mật</Link>
