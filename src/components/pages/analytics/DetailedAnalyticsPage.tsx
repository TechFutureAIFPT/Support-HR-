      ...
      <div className="custom-scrollbar min-h-0 flex-1 overflow-y-auto px-4 pb-6 pt-3 md:px-6 md:pt-5">
        <div className="mx-auto max-w-[1400px] space-y-5">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            ...
            <div className="group relative overflow-hidden bg-gradient-to-br from-[#11213A] to-[#0B192C] border border-amber-500/20 p-3.5 hover:border-amber-500/40 transition-all duration-300 shadow-xl shadow-amber-500/5 rounded-xl">
              <div className="absolute top-0 right-0 w-20 h-20 bg-amber-500/5 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2 transition-all duration-500 group-hover:bg-amber-500/10" />
              <div className="flex items-center justify-between mb-2">
                <span className="text-[10px] text-amber-400 uppercase tracking-wider font-bold">Trung bình</span>
                <div className="w-7 h-7 rounded-lg bg-amber-500/10 border border-amber-500/20 flex items-center justify-center shadow-lg shadow-amber-500/5">
                  <Award className="w-3.5 h-3.5 text-amber-400" />
                </div>
              </div>
              <p className="text-2xl font-black text-amber-400 tracking-tighter">{analyticsData.avgScore}</p>
              <div className="flex items-center gap-1 mt-1">
                <span className="text-[9px] text-amber-400 font-semibold">điểm trung bình</span>
              </div>
            </div>
          </div>
            ...
            <div className="relative overflow-hidden  bg-gradient-to-br from-[#11213A] to-[#0B192C] border border-slate-800/60 p-5 shadow-xl shadow-black/20">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
                {analyticsData.topPerformers.map((c, idx) => (
                  <div key={c.id} className={`relative overflow-hidden  border p-3.5 transition-all duration-300 hover:-translate-y-1 ${idx === 0 ? 'bg-gradient-to-br from-amber-500/10 to-orange-500/5 border-amber-500/30 shadow-lg shadow-amber-500/5' :
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      <div className={`w-7 h-7  flex items-center justify-center text-xs font-black ${idx === 0 ? 'bg-amber-500/20 text-amber-400' :
