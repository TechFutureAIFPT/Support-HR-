...
function FooterLink({
  ...
  const className =
    "block text-base text-slate-500 transition-colors duration-200 hover:text-slate-900 sm:text-[1.05rem]";
      ...
      <div className="relative px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
        <div className="relative overflow-hidden">
          <div className="pointer-events-none absolute inset-x-0 top-16 hidden justify-center lg:flex">
            <p className="supporthr-mono select-none text-[8.5rem] font-semibold uppercase leading-none tracking-[0.08em] text-slate-900/[0.05]">
              SUPPORT HR
            </p>
          </div>
          ...
          <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_auto] lg:gap-16">
            <div className="relative z-10 flex flex-col gap-6">
              <div className="flex items-center gap-3">
                ...
                <span className="supporthr-mono text-2xl font-semibold uppercase tracking-[0.04em] text-slate-900">
                  Support HR
                </span>
              </div>

              <div className="lg:hidden">
                <p className="supporthr-mono select-none text-4xl font-semibold uppercase tracking-[0.16em] text-slate-900/[0.06] sm:text-6xl">
                  SUPPORT HR
                </p>
              </div>
          ...
          <div className="mt-8 border-t border-blue-100 pt-4 sm:mt-9 sm:pt-5">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div className="space-y-1.5">
                ...
                <div className="flex flex-col gap-0.5 text-sm text-slate-600 sm:flex-row sm:flex-wrap sm:gap-x-4 sm:gap-y-1">
                  <a href="mailto:support@supporthr.vn" className="transition-colors hover:text-slate-500">
                    support@supporthr.vn
                  </a>
                  <a href="tel:0899280108" className="transition-colors hover:text-slate-500">
                    0899 280 108
                  </a>
                </div>
              </div>
