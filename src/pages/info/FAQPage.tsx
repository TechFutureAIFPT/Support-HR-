...
const sections = [
  ...
  { id: "setup", title: "Khởi động sử dụng", icon: "fa-rocket", tone: "violet" },
...
const FAQPage: React.FC = () => {
  ...
  const renderSectionContent = () => {
    switch (activeSection) {
        ...
        return (
          <div className="space-y-4">
            <LegalCallout tone="cyan" icon="fa-circle-question" title="Support HR được xây cho kiểu đội ngũ nào?">
              ...
              thể rà soát cho các bên liên quan.
            </LegalCallout>
            <LegalCard tone="cyan" icon="fa-briefcase" title="Tình huống dùng phổ biến">
              <LegalBulletGrid
                ...
                items={[
                  ...
                  "Một quy trình danh sách đề cử có thể lặp lại cho cả đội",
                ]}
              />
            </LegalCard>
          </div>
        ...
        return (
          <div className="space-y-4">
            ...
            <LegalCard tone="emerald" icon="fa-user-shield" title="Dữ liệu ứng viên có được xử lý cẩn thận không?">
              <p>
                Sản phẩm được thiết kế để dùng đúng các file và ngữ cảnh tài khoản cần cho quy trình sàng lọc, chứ không
            ...
            <LegalCard tone="sky" icon="fa-scale-balanced" title="Điểm số nên được dùng như thế nào?">
              <LegalBulletGrid
                ...
                items={[
                  ...
                  "Như gợi ý để con người rà soát sâu hơn",
      ...
      case "setup":
        return (
          <div className="space-y-4">
            <LegalCard tone="violet" icon="fa-list-check" title="Bước khởi động sử dụng sẽ diễn ra như thế nào?">
              <LegalBulletGrid
                tone="violet"
                items={[
                  ...
                  "Rà soát cùng nhau danh sách đề cử và định dạng báo cáo",
                ]}
              />
            </LegalCard>
          </div>
        ...
        return (
          <div className="space-y-4">
            <LegalCard tone="rose" icon="fa-tags" title="Các gói khác nhau ở đâu?">
              <p>
                Các gói chủ yếu khác nhau ở số lượng CV theo tháng, số chuyên viên tuyển dụng tham gia và mức hỗ trợ khởi động,
  ...
  return (
    <LegalPageLayout
      ...
      subtitle="Bộ hỏi đáp thực dụng cho bên mua và giai đoạn bắt đầu sử dụng, dành cho đội ngũ muốn hiểu rõ độ phù hợp, quy trình và kỳ vọng vận hành trước khi dùng Support HR."
